...
steps:
  ...
  hypopharyngeal-cancer---primary:
    run: hypopharyngeal-cancer---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  cancer-monitoring---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: hypopharyngeal-cancer---primary/output
  ...
  cancer-orifice---primary:
    run: cancer-orifice---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  cancer-pylorus---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: cancer-orifice---primary/output
  ...
  cancer-naevi---primary:
    run: cancer-naevi---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  cancer-behaviour---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: cancer-naevi---primary/output
  output-cases:
